...
// ..... complete ...
    ...
    public static void Print(String movie, String ciphersuite, 
                                String hcheck, String key, 
                                int nf, int ms, int count, int etm){
        ...
        PrintStats(movie, ciphersuite, key, ksize, hcheck, nf, afs, ms, etm, frate, tput);
        return;
    }
}
