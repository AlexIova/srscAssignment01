 ...
 */
	...
	public static void print(String movie, String ciphersuite, String hcheck, String key, 
								int count, int sizeTot, int sizeC, int sizeD, int time, int discarded){

		int ksize = 4 * key.length();
		int afs = sizeTot/count;
		int frate = count/time;
		int tput = (sizeTot/1000)/time;
		int asesegments = sizeC/count;
		int asdecsegments = sizeD/count;

		PrintStats(movie, ciphersuite, hcheck, key, ksize, 
